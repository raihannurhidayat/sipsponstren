...
export const AnalyticsReportPdf = ({
  ...
  <Page size="A4" style={styles.page}>
    <Text style={styles.header}>Laporan Analisis</Text>
    ...
    <View style={styles.section}>
      ...
      <View style={styles.statRow}>
        <Text style={styles.statLabel}>Persentase Pengajuan</Text>
        <Text style={styles.statValue}>{approvalRate.toFixed(1)}%</Text>
      </View>

      <View style={styles.statRow}>
        <Text style={styles.statLabel}>Jenis Surat yang paling sering diajukan</Text>
